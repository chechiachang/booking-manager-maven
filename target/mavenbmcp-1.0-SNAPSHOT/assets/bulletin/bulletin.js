...
function IsComfort() {
    ...
    if (CO2 > 1000) {
        ...
        $('div#CO2BadgeContainer div:nth-child(1)').addClass("color-badge-active");
    ...
    if (humid > 80) {
        ...
        $('div#THBadgeContainer div.color-badge').removeClass("color-badge-active");
        $('div#THBadgeContainer div:nth-child(3)').addClass("color-badge-active");
        ...
        $('div#THBadgeContainer div.color-badge').removeClass("color-badge-active");
        $('div#THBadgeContainer div:nth-child(1)').addClass("color-badge-active");
        $('input#humidComfort').addClass("comfort-red");
    }
}
