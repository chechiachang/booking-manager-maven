...
$('.jSave').on('click', function(){
	$.fn.jAlert({
		...
		'message': "<div style='font-size: 120%;'>It's Easy, Fast, and FREE.</div><br><b>1. <span style='color: rgb(0, 158, 255);'>Connect</span> via Facebook (below).<br><br>2. We'll <span style='color: rgb(0, 158, 255);'>auto-post</span> to your wall.<br><small><i>\"This is a preview of what we will be posting.\"</i></small><br><br>3. You'll get a coupon to <span style='color: rgb(0, 158, 255);'>save</span> 10%!</b><br><br><a class='fb-button jSaveBtn'> Connect & Post</a>",
		'theme': 'dark',
		'size': 'small'
	});
});
...
$('body').on('click', '.fb-button', function(e){
  ...
  }, {scope: 'email, publish_stream'}); //you don't need the email permission, but I'd assume you'll want to store it somewhere
